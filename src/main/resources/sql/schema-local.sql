...
CREATE TABLE HOME_CAROUSEL (
    HOME_CAROUSEL_ID BIGINT NOT NULL AUTO_INCREMENT COMMENT 'ID',
    TITLE VARCHAR(50) COMMENT '제목',
    IMAGE_SRC VARCHAR(2000) COMMENT '이미지경로',
    ...
    CREATE_AT DATETIME DEFAULT NOW() COMMENT '작성일자',
    UPDATE_AT DATETIME COMMENT '변경일자',
    CONSTRAINT PK_HOME_CAROUSEL PRIMARY KEY(HOME_CAROUSEL_ID)
);

DROP TABLE IF EXISTS HOME_PRESENT CASCADE;
CREATE TABLE HOME_PRESENT (
    HOME_PRESENT_ID BIGINT NOT NULL AUTO_INCREMENT COMMENT 'ID',
    PRODUCT_ID BIGINT NOT NULL COMMENT '상품 ID',
    ORDINAL_POSITION INT COMMENT '순서',
    USE_YN CHAR(1) DEFAULT 'Y' COMMENT '사용유무',
    CREATE_AT DATETIME DEFAULT NOW() COMMENT '작성일자',
    UPDATE_AT DATETIME COMMENT '변경일자',
    CONSTRAINT PK_HOME_PRESENT PRIMARY KEY(HOME_PRESENT_ID),
    CONSTRAINT FK_HOME_PRESENT FOREIGN KEY (PRODUCT_ID) REFERENCES PRODUCT (PRODUCT_ID)
);
